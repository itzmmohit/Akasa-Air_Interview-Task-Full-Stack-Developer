...
function create( opts ) {
    ...
    const SESSION_TTL = opts.session_ttl || ( 60 * 60 * 24 );
    const RESET_CODE_TTL = opts.reset_code_ttl || ( 60 * 60 * 4 );

    const user_db = new DS( opts.users_file || "users.json" );
    const active_sessions = new DS( opts.sessions_file || "sessions.json" );
